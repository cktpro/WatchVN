...
?>
<div class="main_container p-2 my-4">
  ...
  <tr>
    ...
    <?php if ($row['tinh_trang_dh']=='1' or $row['tinh_trang_dh']=='2' ) {
     ?>
          <td><a class="btn btn-sm btn-danger" onclick="return confirm('Bạn có muôn hủy đơn hàng?');" href="?menu=xu_ly&ma_dh=<?php echo $row['ma_dh']; ?>">Hủy đơn hàng</a></td>
        <?php } ?>
      </tr>
                  </table>
                </div>
