<?php
	...
	// 'select * from san_pham join cau_hinh on san_pham.masp= cau_hinh.masp where san_pham.masp='--> 
	$sql="select * from san_pham join ct_san_pham on san_pham.masp=ct_san_pham.masp join danh_muc_sp on ct_san_pham.doi_tuong_sd=danh_muc_sp.id_danh_muc where ct_san_pham.doi_tuong_sd like 2";
...
<div class="main_container">
	...
	<h3 class="col-md-5 float-left mt-2 px-0">Đồng Hồ Nữ</h3>
	...
	<div class="product-list">
		<?php
		$sl = "select * from san_pham join ct_san_pham on san_pham.masp= ct_san_pham.masp join danh_muc_sp on ct_san_pham.doi_tuong_sd=danh_muc_sp.id_danh_muc where ct_san_pham.doi_tuong_sd like 2 order by " . $_SESSION['sort'] . " limit ".$start.",".$limit;
