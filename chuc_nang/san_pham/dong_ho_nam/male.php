...
$sql = "select * from san_pham join ct_san_pham on san_pham.masp=ct_san_pham.masp join danh_muc_sp on ct_san_pham.doi_tuong_sd=danh_muc_sp.id_danh_muc where ct_san_pham.doi_tuong_sd like 1";
...
<div class="main_container">
	<div class="dst_hphukien">
		<h3 class="col-md-6 float-left mt-2 px-0">Đồng Hồ Nam</h3>
		...
		<div class="product-list">
			<?php
			$sl = "select * from san_pham join ct_san_pham on san_pham.masp= ct_san_pham.masp join danh_muc_sp on ct_san_pham.doi_tuong_sd=danh_muc_sp.id_danh_muc where ct_san_pham.doi_tuong_sd like 1 order by " . $_SESSION['sort'] . " limit " . $start . "," . $limit;
