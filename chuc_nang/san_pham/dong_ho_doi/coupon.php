<?php
	...
	$sql="select * from san_pham join ct_san_pham on san_pham.masp=ct_san_pham.masp join danh_muc_sp on ct_san_pham.doi_tuong_sd=danh_muc_sp.id_danh_muc where ct_san_pham.doi_tuong_sd like 3";
...
<div class="main_container">
	...
	<h3 class="col-md-5 float-left mt-2 px-0">Đồng Hồ Đôi</h3>
	...
	<div class="product-list">
		<?php
		$sl = "select * from san_pham join ct_san_pham on san_pham.masp= ct_san_pham.masp join danh_muc_sp on ct_san_pham.doi_tuong_sd=danh_muc_sp.id_danh_muc where ct_san_pham.doi_tuong_sd like 3 order by " . $_SESSION['sort'] . " limit ".$start.",".$limit;
