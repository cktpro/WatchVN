<?php
  ...
  mysqli_select_db($connect,"bandh");
  mysqli_query($connect, "SET names 'utf8'");
  if(!$connect){
    echo "Không thể kết nối đến Database!".mysqli_connect_error($connect);
  }
  $sl="select * from hoa_don where month(ngay_mua)=6 limit 0,3 ";
              ...
              <div class="card h-100">
                <div class="card-body">
                  <div class="row align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-uppercase mb-1">Thu Nhập (Monthly)</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo number_format($tg,0,",",".")." đ"; ?></div>
              ...
              <div class="card h-100">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-uppercase mb-1">Sản Phẩm Bán Ra</div>
