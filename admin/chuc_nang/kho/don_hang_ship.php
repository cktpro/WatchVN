...
?>
                      <tr>
                        ...
                        <td><a class="btn btn-sm btn-outline-primary"  href="?menu=xuat_kho&ma_dh=<?php echo $row['ma_dh']; ?>&stt=1">Xuất kho</a></td>
                        <?php } ?>
                        ...
                        <td><a class="btn btn-sm btn-outline-success"  href="?menu=hoan_kho&ma_dh=<?php echo $row['ma_dh']; ?>">Hoàn kho</a></td>
                        <?php } ?>
